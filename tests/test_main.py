...
@pytest.mark.parametrize("a_string, b_string, operation_string, expected_string", [
    ...
    ("-5", "3", 'add', "The result of -5 add 3 is equal to -2"),  # Addition with negative number
    ("3", "5", 'subtract', "The result of 3 subtract 5 is equal to -2"),  # Subtraction resulting in negative
    ("10", "0", 'multiply', "The result of 10 multiply 0 is equal to 0"),  # Multiplying by zero
    ("10", "4", 'divide', "The result of 10 divide 4 is equal to 2.5"),  # Division with non-zero decimal result
    ("@", "3", 'add', "Invalid number input: @ or 3 is not a valid number.")  # Invalid input with special characters
])
